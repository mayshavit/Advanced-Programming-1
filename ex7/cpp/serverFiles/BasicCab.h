...
/*
 * The BasicCab class.
 * This is an abstract class with abstract methods, (like an interface).
 * It makes the program more generic so we could use it with every cab.
 */
enum Manufacturer {
...
public:
    ...
    /*
     * Function that serializes Basic cab
     */
