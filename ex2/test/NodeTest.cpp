...
/*
 * Test that checks the numOfNeighbors - by default, when we create a Node instance,
 * it should be 4.
 */
...
/*
 * test that checks the neighbors update - if they were created and added successfully.
 * afterwards, we call the deleteNeighbours function that frees the memory we allocated
 * for each neighbour.
 */
