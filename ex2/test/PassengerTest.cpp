...
TEST_F(PassengerTest, getPoints) {
    ...
    EXPECT_TRUE(p1.isEqual(passenger.getStartPoint()));
    EXPECT_TRUE(p2.isEqual(passenger.getEndPoint()));
}

/*
 * Test that checks the satisfaction update - the value of satisfaction should be
 * between 1 to 5 (that means that: 1<=satisfaction<=5).
 */
