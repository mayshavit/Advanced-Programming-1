...
public:
    ...
    ***********************************************************************/
    virtual int sendData(string data, int client) = 0;
    ...
    * the data															   *
    ***********************************************************************/
    virtual int reciveData(char *buffer, int size, int client) = 0;

    /***********************************************************************
     * function name: connectAclient                                       *
     * The input : none                                                    *
     * The output : int number, representing an "id" for client. Each      *
     * client has its own id.                                              *
     * The Function operaton:                                              *
     **********************************************************************/
    virtual int connectAClient() = 0;
